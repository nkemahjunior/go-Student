                ...
                <div className=" overflow-auto">
                    <table className=" w-full   border-stone-300 border border-collapse table-auto">
                        ...
                        <thead>
                            ...
                            <th className="p-4 text-sm bg-stone-200 text-start">Course&nbsp;Title</th>
                            <th className="p-4 text-sm bg-stone-200">Credit&nbsp;Value</th>
                            <th className="p-4 text-sm bg-stone-200">Course&nbsp;Status</th>
                            <th className="p-4 text-sm bg-stone-200 text-start">Course&nbsp;Instructor(s)</th>
                            </tr>
                        </thead> 
                        ...
                        <tbody className="">
...

                            {
                                major?.map((el,i) => (
                                    ...
                                    <td className=" font-light p-4 text-start uppercase  whitespace-nowrap">
                                    {el.courseName}
                                    </td>
                                    ...
                                    <td className="font-light p-4 text-start capitalize  whitespace-nowrap">
                                    {el.teacherName}
                                    </td>
